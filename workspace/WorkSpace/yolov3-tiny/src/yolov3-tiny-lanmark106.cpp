...
int test_cam()
{
    ...
    detector.load_param("../models/yolo/yolov3-tiny/yolov3-tiny-face-merge-opt-fp16.param");
    detector.load_model("../models/yolo/yolov3-tiny/yolov3-tiny-face-merge-opt-fp16.bin");
