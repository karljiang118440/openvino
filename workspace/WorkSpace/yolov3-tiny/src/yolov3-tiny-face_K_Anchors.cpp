...
int test_cam()
{
    ...
    detector.load_param("../models/yolo/yolov3-tiny-face_K_Anchors/yolov3-tiny-face_K_Anchors_last-merge-opt-fp16.param");
    detector.load_model("../models/yolo/yolov3-tiny-face_K_Anchors/yolov3-tiny-face_K_Anchors_last-merge-opt-fp16.bin");

    int detector_size_width  = 416;
    int detector_size_height = 416;
