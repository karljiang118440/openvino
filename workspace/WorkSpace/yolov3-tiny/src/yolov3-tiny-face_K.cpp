...
int test_cam()
{
    ...
    detector.load_param("../models/yolo/yolov3-tiny-face_K/yolov3-tiny-face_K-merge-opt-fp16.param");
    detector.load_model("../models/yolo/yolov3-tiny-face_K/yolov3-tiny-face_K-merge-opt-fp16.bin");
